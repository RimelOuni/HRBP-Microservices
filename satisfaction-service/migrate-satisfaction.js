/**
 * migrate-satisfaction.js — Copie la collection "satisfactions" du monolithe
 * (base "test") vers la base de satisfaction-service (MONGO_URI du .env).
 * Exécuter UNE SEULE FOIS : node migrate-satisfaction.js
 */
...
const COLLECTION = "satisfactions";
