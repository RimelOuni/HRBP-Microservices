/**
 * migrate-point.js — Copie la collection "points" du monolithe (base "test")
 * vers la base de point-service (MONGO_URI du .env, ex. point-db).
 * Exécuter UNE SEULE FOIS : node migrate-point.js
 */
