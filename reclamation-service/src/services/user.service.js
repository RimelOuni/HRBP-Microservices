...
const getUserById = async (userId, token) => {
  ...
  try {
    ...
    console.error(`[reclamation-service] user.service getUserById(${userId}) failed:`, err.message);
    return null;
  }
};
...
const getCurrentUserProfile = async (token) => {
  try {
    ...
    console.error("[reclamation-service] user.service getCurrentUserProfile failed:", err.message);
    return null;
  }
};
