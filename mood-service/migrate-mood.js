/**
 * migrate-mood.js — Copie la collection "moods" du monolithe (base "test")
 * vers la base de mood-service (MONGO_URI du .env, ex. mood-db).
 * Exécuter UNE SEULE FOIS : node migrate-mood.js
 */
