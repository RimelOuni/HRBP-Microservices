...
const getUserById = async (userId, token) => {
  ...
  try {
    ...
    console.error(`[mood-service] user.service getUserById(${userId}) failed:`, err.message);
    return null;
  }
};
 ...
 * nécessaire pour tous les endpoints "me" de mood-service.
 */
const getCurrentUserProfile = async (token) => {
  try {
    ...
    console.error("[mood-service] user.service getCurrentUserProfile failed:", err.message);
    return null;
  }
};
